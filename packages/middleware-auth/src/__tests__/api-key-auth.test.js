...
describe('API Key Authentication Middleware', () => {
    ...
    describe('createAPIKeyAuthMiddleware', () => {
        it('should create middleware with array of keys', () => {
            const middleware = (0, api_key_auth_1.createAPIKeyAuthMiddleware)({
                keys: ['key1', 'key2', 'key3'],
            });
    ...
    describe('Middleware Handler', () => {
        describe('API Key Validation - Array', () => {
            ...
            it('should reject invalid API key', async () => {
                ...
                await expect(middleware.handler(message, context, mockNext)).rejects.toThrow('Invalid API key');
        ...
        describe('Error Handling', () => {
            it('should throw error when no API key provided', async () => {
                ...
                await expect(middleware.handler(message, context, mockNext)).rejects.toThrow('Authentication required: No API key provided');
                expect(mockNext).not.toHaveBeenCalled();
            });
