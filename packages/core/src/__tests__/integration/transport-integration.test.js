...
const src_1 = require("../../../../transport-http/src");
const zod_1 = require("zod");
const initializeHttpClient = async (baseUrl, clientId, protocolVersion = '2024-11-05') => {
    ...
    describe('HTTP Transport', () => {
        ...
        beforeEach(async () => {
            ...
            server.registerTool({
                ...
                inputSchema: zod_1.z.object({ delay: zod_1.z.number() }),
                handler: async (input) => {
            ...
            transport = new src_1.HttpTransport({
                port: TEST_PORT,
                requestTimeout: 2000,
            });
        ...
        it('should list tools', async () => {
            ...
            const echoTool = result.result.tools.find((t) => t.name === 'echo');
        ...
        it('should handle concurrent requests', async () => {
            ...
            const requests = Array.from({ length: 10 }, (_, i) => fetch(`${BASE_URL}/mcp`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
