 ...
 * Hook handler
 */
export type HookHandler<TContext extends HookContext = HookContext> = (context: TContext) => void | Promise<void>;
/**
 ...
 * Middleware handler
 */
export type MiddlewareHandler<TMetadata extends Metadata = StrictMetadata> = (message: MCPMessage, context: MiddlewareContext<TMetadata>, next: () => Promise<void>) => Promise<void>;
/**
 ...
 */
export type InferToolInput<T extends Tool<any, any>> = T extends Tool<infer I, any> ? I : never;
/**
 * Extract output type from Tool
 */
export type InferToolOutput<T extends Tool<any, any>> = T extends Tool<any, infer O> ? O : never;
/**
 ...
 */
export type TypedMiddleware<TMetadata extends Metadata = StrictMetadata> = Middleware<TMetadata>;
/**
 * Type-safe hook registration helper
 */
export type TypedHook<TContext extends HookContext = HookContext> = LifecycleHook<TContext>;
