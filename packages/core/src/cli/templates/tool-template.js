...
exports.generateToolTest = exports.generateToolFile = void 0;
...
function generateToolFile(options) {
...
exports.generateToolFile = generateToolFile;
function generateToolTest(options) {
    const baseName = toCamelCase(options.name);
    const symbolName = baseName.endsWith('Tool') ? baseName : `${baseName}Tool`;
...
exports.generateToolTest = generateToolTest;
